...
export const List = () => {
  ...
  const [Pic,setPic]=useState("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/25.png");
        ...
        <ListHeader>
          ...
          { pokemon.length && pokemon.map((pokeman, index) => (
            <Pokeman key={index}><Link 
              onMouseOver={() => setPic("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png")}
              onMouseLeave={() => setPic("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/25.png")} 
